...
SELECT 
   ...
   CASE WHEN gender > date_of_admission THEN date_of_admission ELSE gender END AS gender,
   CASE WHEN gender > date_of_admission THEN gender ELSE date_of_admission END AS date_of_admission,
   CASE WHEN gender > admission_type THEN admission_type ELSE gender END AS gender,
   CASE WHEN gender > admission_type THEN gender ELSE admission_type END AS admission_type,
   CASE WHEN gender > discharge_date THEN discharge_date ELSE gender END AS gender,
   CASE WHEN gender > discharge_date THEN gender ELSE discharge_date END AS discharge_date,
...
SELECT 
   ...
   CASE WHEN admission_type > discharge_date THEN discharge_date ELSE admission_type END AS admission_type,
   CASE WHEN admission_type > discharge_date THEN admission_type ELSE discharge_date END AS discharge_date,
   CASE WHEN gender_clean > admission_type_clean THEN admission_type_clean ELSE gender_clean END AS gender_clean,
   CASE WHEN gender_clean > admission_type_clean THEN gender_clean ELSE admission_type_clean END AS admission_type_clean 
