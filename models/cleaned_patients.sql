...
SELECT 
   ...
   MIN(tpep_pickup_datetime, tpep_dropoff_datetime, trip_date) AS tpep_pickup_datetime,
   MIN(tpep_dropoff_datetime, tpep_pickup_datetime, trip_date) AS tpep_dropoff_datetime,
   MIN(trip_date, tpep_pickup_datetime, tpep_dropoff_datetime) AS trip_date 
FROM staging_trips;
