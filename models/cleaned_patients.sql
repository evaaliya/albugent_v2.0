...
DROP TABLE IF EXISTS CLEANED cleaned_raw_patients
...
DROP TABLE IF EXISTS CLEANED cleaned_staging_patients
...
DROP TABLE IF EXISTS CLEANED cleaned_mart_billing
...
DROP TABLE IF EXISTS CLEANED cleaned_mart_demographics
...
DROP TABLE IF EXISTS CLEANED cleaned_customers
...
DROP TABLE IF EXISTS CLEANED cleaned_inventory
...
DROP TABLE IF EXISTS CLEANED cleaned_order_items
...
DROP TABLE IF EXISTS CLEANED cleaned_orders
...
DROP TABLE IF EXISTS CLEANED cleaned_products
...
DROP TABLE IF EXISTS CLEANED cleaned_promotions
...
DROP TABLE IF EXISTS CLEANED cleaned_returns
...
DROP TABLE IF EXISTS CLEANED cleaned_shipments
...
DROP TABLE IF EXISTS CLEANED cleaned_suppliers
...
DROP TABLE IF EXISTS CLEANED cleaned_warehouses
...
DROP TABLE IF EXISTS CLEANED cleaned_raw_trips
...
DROP TABLE IF EXISTS CLEANED cleaned_staging_trips
...
DROP TABLE IF EXISTS CLEANED cleaned_mart_daily_summary
