...
--   * Corrected inverted date logic between 'trip_date' and 'tpep_dropoff_datetime'
-- =====================================================================
...
SELECT 
   ...
   total_amount AS total_amount,
   CASE WHEN trip_date > tpep_dropoff_datetime THEN tpep_dropoff_datetime ELSE trip_date END AS trip_date,
